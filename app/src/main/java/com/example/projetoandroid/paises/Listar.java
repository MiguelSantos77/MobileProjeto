...
public class Listar extends AppCompatActivity {
    ...
    private void criarButoesPais()
    {
       ...
       // textView.setText("asdasdasdasdasdas");
        for(String id: listaIdPaises)
        {
            ...
            textView.setText(listaDePaises.toString());
            ...
            butaoPais.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    Intent i = new Intent(getApplicationContext(), com.example.projetoandroid.clubes.Listar.class);
    ...
    public void trocarParaPaisesCriar(){
